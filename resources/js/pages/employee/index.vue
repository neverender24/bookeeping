<template>
    <div class="container-xl">
						    ...
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    ...
							    <div class="col-auto">
                                    <div class="input-group">
                                        <select class="form-select w-auto" v-model="tableData.sortBy" @change="getData()">
                                            <option value="">Encoded Date</option>
	  ...
	  <path fill-rule="evenodd" d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"></path>
											...
											<li><button class="dropdown-item" @click="edit(item.id)"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
	  <path fill-rule="evenodd" d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5L13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175l-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"></path>
	</svg>Edit</button></li>

    <li><button class="dropdown-item" @click="bmi(item.id)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-speedometer me-2" viewBox="0 0 16 16">
  <path d="M8 2a.5.5 0 0 1 .5.5V4a.5.5 0 0 1-1 0V2.5A.5.5 0 0 1 8 2zM3.732 3.732a.5.5 0 0 1 .707 0l.915.914a.5.5 0 1 1-.708.708l-.914-.915a.5.5 0 0 1 0-.707zM2 8a.5.5 0 0 1 .5-.5h1.586a.5.5 0 0 1 0 1H2.5A.5.5 0 0 1 2 8zm9.5 0a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1H12a.5.5 0 0 1-.5-.5zm.754-4.246a.389.389 0 0 0-.527-.02L7.547 7.31A.91.91 0 1 0 8.85 8.569l3.434-4.297a.389.389 0 0 0-.029-.518z"/>
  <path fill-rule="evenodd" d="M6.664 15.889A8 8 0 1 1 9.336.11a8 8 0 0 1-2.672 15.78zm-4.665-4.283A11.945 11.945 0 0 1 8 10c2.186 0 4.236.585 6.001 1.606a7 7 0 1 0-12.002 0z"/>
</svg>BMI</button></li>
	                                        <li><hr class="dropdown-divider"></li>
											<li><button class="dropdown-item text-danger"  @click="delete_purchase(item.id)"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
import AdvancedFilter from "./filter.vue";
...
export default {
    ...
    data() {
        ...
        let columns = [
            { width: "10%", label: "CATS #", name: "cats_number" },
            { width: "20%", label: "Last Name", name: "last_name" },
            { width: "20%", label: "First Name", name: "first_name" },
                  { width: "20%", label: "Middle Name", name: "middle_name" },
    ...
    methods: {
        ...
        async getData(url = "employee/index") {
        ...
        create() {
            this.$store.commit('setPrimaryModalState', "Add Employee")
        },
        ...
        async edit(id) {
             this.$store.commit('clearEditData', "Edit Employee")
            await axios.post('employee/edit', { id: id }).then( response => {
                this.$store.commit('editing', response.data)
            })
        },

         bmi() {
            this.$store.commit('setPrimaryModalState', "BMI Information")
        },
