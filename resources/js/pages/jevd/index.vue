...
export default {
    ...
    data() {
        ...
        let columns = [
            { width: "10%", label: "recid", name: "recid" },
            { width: "50%", label: "Fiscal Year", name: "fiscalyear" },
            // { width: "50%", label: "Fund Detail Code", name: "FUND_SCODE" },
            { width: "50%", label: "JEV Number", name: "FJEVNO " },
            { width: "50%", label: "JEV Data", name: "FJEVDATE " },
            { width: "50%", label: "JEV Type", name: "FJEVTYP " },
            // { width: "100%", label: "Ctrl No for JEV Type 1,3,4,5,6", name: "FREFNO " },
            { width: "50%", label: "Control No for JEV Type 2", name: "FCHKNO  " },
            { width: "50%", label: "Payee ID", name: "idpayee" },
            { width: "50%", label: "Payee Name", name: "FPAYEE" },
            // { width: "100%", label: "Remarks", name: "FREMK" },
            { width: "50%", label: "Preparing Officer", name: "FPREPBY" },
            // { width: "100%", label: "Preparing Officer Position", name: "FPREPD" },
            { width: "50%", label: "Approving officer", name: "FAPPVBY" },
            { width: "50%", label: "Approving officer position", name: "FAPPVD" },
            { width: "50%", label: "User ID", name: "FUSER" },
            { width: "50%", label: "Action", name: "action" }, 
        ];
