<template>
    <div class="container-xl">
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">PPMP</h1>
				    </div>
				    <div class="col-auto">
			  ...
			  <path fill-rule="evenodd" d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"></path>
									    ...
									    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start" style="font-size: .8125rem;">
										   <li><button class="dropdown-item" @click="edit_ppmp_item(item.id)"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
	  <path fill-rule="evenodd" d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5L13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175l-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"></path>
	</svg>Edit</button></li>
	                                        <li><hr class="dropdown-divider"></li>
											<li><button class="dropdown-item text-danger"  @click="delete_user(item.id)"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
	  ...
	  <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path>
			    ...
			    <modal v-if="editModal" @refresh="getData()"></modal>
		    </div>
</template>
...
export default {
    ...
    computed: {
        ...mapState({
            editModal: state => state.ppmpItems.editModal,
    ...
    methods: {
        ...
        getData(url = "ppmp/items/index") {
                let loader = this.$loading.show();
                _.assign(this.tableData, {id_ppmp: this.id_ppmp});
        ...
        create() {
            this.$store.commit('createPpmpItems')
        },
        ...
        edit_ppmp_item(id) {
            ...
            axios.post('/ppmp/items/edit', { id: id }).then( response => {
                this.$store.commit('editingPpmpItems', response.data)
            })
        },
